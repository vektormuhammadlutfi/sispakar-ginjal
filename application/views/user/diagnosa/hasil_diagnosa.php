    ...
    <div class="box box-success" style="background: #ffffff; height: auto;">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                $in = $this->db->query("INSERT INTO tb_hasilcf (id_user, kd_penyakit, nama_penyakit, kepercayaan) VALUES($this->session->userdata('id_user'), 'P007', 'asdas', ".round($best['value'] * 100)." ) ");
                ?>
