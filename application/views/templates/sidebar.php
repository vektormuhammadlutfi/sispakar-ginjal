      ...
      <aside>
          <div id="sidebar"  class="nav-collapse" style="background: #ffffff;">
              ...
              <ul class="sidebar-menu">
                  <li>
                      <a class="" href="<?php echo site_url() ?>/dashboard" style="background: #ffffff; color: #688A7E;">
                          <i class="icon_laptop" style="color: #688A7E;"></i>
                          <span>Halaman Utama</span>
                      </a>
                  </li>                
                  <li>
                      <a class="" href="<?php echo site_url() ?>/home" style="background: #ffffff; color: #688A7E;">
                          <i class="icon_house_alt" style="color: #688A7E;"></i>
                          <span>Beranda</span>
                      </a>
                  </li>
                  <li>
                      <a class="" href="<?php echo site_url() ?>/penyakit" style="color: #688A7E; background:#ffffff;">
                          <i class="fa fa-medkit" style="color: #688A7E; background: #ffffff;"></i>
