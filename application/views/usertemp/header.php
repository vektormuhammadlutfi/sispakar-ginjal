...
<html lang="en">
<head>
<title>Kidney Disease Care</title>
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
					...
					if($this->session->userdata('is_login') == TRUE && $this->session->userdata('level') == 'pasien'){
					?>
          			<li class="menu_item menu_mm"><a href="<?php echo site_url() ?>/login_user/logout"><?php echo $this->session->userdata('username') ?>,  Logout </a></li>
					<?php } else{ ?>
